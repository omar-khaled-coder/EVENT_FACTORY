class SpacesController < ApplicationController
  ...
  private
    ...
    def space_params
      params.require(:space).permit(:owner_id, :title, :description, :address, :city, :state, :country, :postal_code, :space_type, :capacity, :amenities, :price_per_hour, :price_per_day, :start_date, :end_date, :is_hourly_available, :is_daily_available)
    end
end
